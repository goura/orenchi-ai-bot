...
For mocking in tests, use Bun's built-in mocking capabilities:

```ts#mocking-example.test.ts
...
Or use jest-compatible syntax:

```ts#jest-mocking-example.test.ts
import { test, expect, jest } from "bun:test";

// Jest-compatible mock
